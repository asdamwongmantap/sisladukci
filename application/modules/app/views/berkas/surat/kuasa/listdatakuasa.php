			...
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
				  ...
				  <a href="<?=base_url('app/surat/addsuratkuasa');?>" class="btn btn-success" title="Tambah user group" data-target=".bs-example-modal-smadd" style="float:right;display:block;" 
				  ...
				  <table id="mydata" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody id="show_data">
							...
							<tr>
									...
									?>					
									<td><a class="btn btn-success" href='pdfkuasa/<?=$nosurat;?>'><i class="glyphicon glyphicon-print icon-white"></i></a>
