    ...
    <div class="container body">
      <div class="main_container">
		  ...
		  <!--form add-->
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Pembuatan Surat Kuasa</h2>
                    <div class="clearfix"></div>
					
                  </div>
                  <div class="x_content">
				  <form id="form-addkuasa" data-parsley-validate class="form-horizontal form-label-left" method="post">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wrg_namapihak2">Nama Pihak 2
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tmpatlahir_pihak2">Tempat Lahir Pihak 2
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgllahir_pihak2">Tanggal Lahir Pihak 2 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pekerjaan_pihak2">Pekerjaan Pihak 2
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="pekerjaan_pihak2" name="pekerjaan_pihak2" required="" maxlength="50" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alamat_pihak2">Alamat Pihak 2 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="alamat_pihak2" class="form-control" name="alamat_pihak2" required="" maxlength="100" ></textarea>
                        </div>
                      </div>
					  <div class="form-group">
		...
		$('#myDatepicker2').datetimepicker({
			...
			//proses add
			$('#form-addkuasa').on('submit',function(e) {
			var form = $('#form-addkuasa')[0];
			...
			swal({
			  ...
			  showLoaderOnConfirm: true
				...
				$.ajax({
					...
					url:'<?=base_url('app/surat/savekuasa');?>',
					data: data,
					processData: false,
					contentType: false,
					cache: false,
					success:function(e){
						...
						swal({
						  ...
						  type: "success"
							...
							window.location='<?=base_url('app/surat/listkuasa');?>';
						  });
						}
						else{
						swal({
