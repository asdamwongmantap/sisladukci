	...
	function WordWrap(&$text, $maxwidth)
{
	...
	function Content($data1)
	{
                ...
                $this->setFillColor(255,255,255);
				 ...
				 $this->cell(87,6,'',0,0,'C',0); 
				 $this->cell(20,6,"SURAT IZIN MENIKAH",0,1,'C',1);
				//  $this->Ln(1);
				 $this->setFont('Arial','',12);
				 $this->setFillColor(0,0,0);
				 $this->cell(75);
                ...
                $this->Ln(7);
                 ...
                 $this->cell(43,6,'',0,0,'C',0);
                 $this->cell(20,6,"Yang bertanda tangan dibawah ini, Saya:",0,1,'C',1);
                 ...
                 $this->Ln(7);
                 $this->cell(30,6,'',0,0,'C',0);
                 $this->cell(10,10,'Pekerjaan                 : '.$u->wrg_pekerjaan) ;
                 $this->Ln(7);
                 $this->cell(30,6,'',0,0,'C',0);
                 ...
                 $this->Ln(7);
                 $this->cell(30,6,'',0,0,'C',0);
                 $this->cell(10,10,'Alamat                      : '.$u->wrg_alamat) ;
                 $this->Ln(10);
                 $this->cell(30,6,'',0,0,'C',0);
                 $this->cell(10,10,'DATA AYAH             :') ;
                 $this->Ln(10);
                 $this->cell(30,6,'',0,0,'C',0);
                ...
                // $this->WordWrap($text,120);
                 $this->cell(20,6,"Bersama ini menyatakan dengan sesungguhnya bahwa sampai saat ini belum",0,1,'C',1);
                 $this->cell(67,6,'',0,0,'C',0); 
                // $this->WordWrap($text,120);
                 $this->cell(20,6,"pernah menikah / pernah menikah, dan hingga saat ini masih berstatus",0,1,'C',1);
                 $this->cell(18,6,'',0,0,'C',0);
                 $this->cell(20,6,strtoupper($u->wrg_statuskawin),0,1,'C',1);
                 $this->Ln(3);
