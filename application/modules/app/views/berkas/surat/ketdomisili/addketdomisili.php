    ...
    <div class="container body">
      <div class="main_container">
		  ...
		  <!--form add-->
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Pembuatan Surat Keterangan Domisili</h2>
                    <div class="clearfix"></div>
					
                  </div>
                  <div class="x_content">
				  <form id="form-addketdomisili" data-parsley-validate class="form-horizontal form-label-left" method="post">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wrg_nik">NIK Pemohon 
                        </label>
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wrg_nama">Nama Pemohon
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="wrg_namapemilik">Nama Pemilik Rumah
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="wrg_namapemilik" name="wrg_namapemilik" required="" maxlength="50" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
					  <div class="form-group">
		...
		$('#myDatepicker2').datetimepicker({
			...
			//proses add
			$('#form-addketdomisili').on('submit',function(e) {
			var form = $('#form-addketdomisili')[0];
			...
			swal({
			  ...
			  showLoaderOnConfirm: true
				...
				$.ajax({
					...
					url:'<?=base_url('app/surat/saveketdomisili');?>',
					data: data,
					processData: false,
					contentType: false,
					cache: false,
					success:function(e){
						...
						swal({
						  ...
						  type: "success"
							...
							window.location='<?=base_url('app/surat/listketdomisili');?>';
						  });
						}
						else{
						swal({
