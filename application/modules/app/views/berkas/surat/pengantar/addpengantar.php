    ...
    <div class="container body">
      <div class="main_container">
		  ...
		  <!--form add-->
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Pembuatan Surat Pengantar</h2>
                    <div class="clearfix"></div>
					
                  </div>
                  <div class="x_content">
				  <form id="form-addpengantar" data-parsley-validate class="form-horizontal form-label-left" method="post">
		...
		$('#myDatepicker2').datetimepicker({
			...
			//proses add
			$('#form-addpengantar').on('submit',function(e) {
			var form = $('#form-addpengantar')[0];
			...
			swal({
			  ...
			  showLoaderOnConfirm: true
				...
				$.ajax({
					...
					url:'<?=base_url('app/surat/savepengantar');?>',
					data: data,
					processData: false,
					contentType: false,
					cache: false,
					success:function(e){
						...
						swal({
						  ...
						  type: "success"
							...
							window.location='<?=base_url('app/surat/listsuratpengantar');?>';
						  });
						}
						else{
						swal({
