	...
	function WordWrap(&$text, $maxwidth)
{
	...
	function Content($data1)
	{
                ...
                $this->setFillColor(255,255,255);
				 ...
				 $this->cell(87,6,'',0,0,'C',0); 
				 $this->cell(20,6,"SURAT PENGANTAR",0,1,'C',1);
				//  $this->Ln(1);
				 $this->setFont('Arial','',12);
				 $this->setFillColor(0,0,0);
				 $this->cell(75);
                ...
                // $this->WordWrap($text,120);
                 ...
                 $this->cell(20,6,"kecamatan kramatwatu, dengan ini menerangkan bahwa:",0,1,'C',1);
                 ...
                 $this->Ln(7);
                 $this->cell(30,6,'',0,0,'C',0);
                 $this->cell(10,10,'Maksud & Keperluan: '.$u->tujuan) ;
