    ...
    <div class="container body">
      <div class="main_container">
		  ...
		  <!--form add-->
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laporan Keuangan RT.007 RW.003</h2>
                    <div class="clearfix"></div>
					
                  </div>
                  <div class="x_content">
				  <form id="form-laporankeuangan" data-parsley-validate class="form-horizontal form-label-left" method="post" >
					   
				  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jenis_laporankeuangan">Bulan 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_single form-control" tabindex="-1" id="jenis_laporankeuangan" name="jenis_laporankeuangan">
		...
		$('#myDatepicker2').datetimepicker({
			...
			//proses add
			$('#form-laporankeuangan').on('submit',function(e) {
			
			var jenislaporan = $('#jenis_laporankeuangan').val();
			...
			swal({
				...
				window.location.href ='<?=base_url('app/laporan/pdflaporankeuangan/');?>'+jenislaporan;
				return false;
				});
