<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="<?=base_url();?>assets/js/fungsicheckboxpersonal2.js"></script>
	<script src="<?=base_url();?>assets/js/fungsicheckboxcompany.js"></script>
	<script src="<?=base_url();?>assets/js/fungsivalidasi.js"></script>
