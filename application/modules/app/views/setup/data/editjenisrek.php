    ...
    <div class="container body">
      <div class="main_container">
		  ...
		  <!--form add-->
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ubah Jenis Rekening</h2>
                    <div class="clearfix"></div>
					
                  </div>
                  <div class="x_content">
				  <?php foreach ($dataeditjenis as $row) {?>
				  <form id="form-editjenisrek" data-parsley-validate class="form-horizontal form-label-left" method="post">
					 ...
					 <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="kd_jenisakun" name="kd_jenisakun" required="" maxlength="100" class="form-control col-md-7 col-xs-12" value="<?=$row->kd_jenisakun;?>">
                        </div>
                      </div>
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="desc_jenisakun" class="form-control" name="desc_jenisakun" required="" maxlength="100"><?=$row->desc_jenisakun;?></textarea>
                        </div>
                      </div>
		...
		<script type="text/javascript">
			//proses add
			$('#form-editjenisrek').on('submit',function(e) {
			var form = $('#form-editjenisrek')[0];
			...
			swal({
			  ...
			  showLoaderOnConfirm: true
				...
				$.ajax({
					...
					url:'<?=base_url('app/jenis_rek/saveeditjnsrek');?>',
					data: data,
					processData: false,
					contentType: false,
					cache: false,
