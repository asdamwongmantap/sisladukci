    ...
    <div class="container body">
      <div class="main_container">
			...
			<div class="row">
              <div class="col-md-12 col-sm-4 col-xs-12">
                <div class="x_panel">
				  ...
				  <form id="form-editkelurahan" data-parsley-validate class="form-horizontal form-label-left" method="post">
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id="kel_id" name="kel_id" required="" maxlength="16" class="form-control col-md-7 col-xs-12" value="<?=$row->kel_id;?>">
                        </div>
                      </div>
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text"  id="kel_nama" name="kel_nama" required="" maxlength="50" class="form-control col-md-7 col-xs-12" value="<?=$row->kel_nama;?>">
                        </div>
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="kel_alamat"  class="form-control" name="kel_alamat" required="" maxlength="100" ><?=$row->kel_alamat;?></textarea>
                        </div>
                      </div>
		...
		<script type="text/javascript">
			//proses add
			$('#form-editkelurahan').on('submit',function(e) {
			var form = $('#form-editkelurahan')[0];
			...
			swal({
			  ...
			  showLoaderOnConfirm: true
				...
				$.ajax({
					...
					url:'<?=base_url('app/data/kelurahan/saveeditkelurahan');?>',
					data: data,
					processData: false,
					contentType: false,
					cache: false,
